    ...
    override suspend fun answer(ingredients: String, question: String): String {
        ...
        return when {
            ...
            q.contains("msg") || q.contains("e621") -> {
                ...
                msg?.let {
                    "${it.name} is a flavour enhancer and is generally considered safe at normal dietary levels. The more useful question is the overall food — especially sodium and how often you eat it."
            ...
            q.contains("daily") || q.contains("every day") || q.contains("often") ->
                "If this is an everyday food, I'd zoom out from one additive and look at sugar, sodium, saturated fat, protein and fibre too. Frequency changes the nutrition picture."
            q.contains("sugar") ->
                if (insights.any { it.key == "sugar" }) {
                    "Sugar appears in the ingredient list. The ingredient list tells us presence, not quantity — the nutrition panel is needed to judge how much you're getting."
                } else {
                    "I don't see sugar in the ingredient text I received. The nutrition panel would give us a more reliable answer."
                }
